...
export const registerUser = (userData) => {
  return fetch(`${URL_DEV}/auth/signup/`, {
    method: "POST",
...
export const loginUser = (username, password) => {
  return fetch(`${URL_DEV}/auth/signin/`, {
    method: "POST",
    headers: headersWithContentType,
...
export const getOwnWishes = () => {
  return fetch(`${URL_DEV}/users/me/wishes`, {
    method: "GET",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const getAnotherUserWishes = (username) => {
  return fetch(`${URL_DEV}/users/${username}/wishes`, {
    method: "GET",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const getAnotherUser = (username) => {
  return fetch(`${URL_DEV}/users/${username}`, {
    method: "GET",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const queryUser = (query) => {
  return fetch(`${URL_DEV}/users/find`, {
    method: "POST",
    headers: headersWithAuthorizeFn(),
...
export const removeWish = (id) => {
  return fetch(`${URL_DEV}/wishes/${id}`, {
    method: "DELETE",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const getTopCards = () => {
  return fetch(`${URL_DEV}/wishes/top`, {
    method: "GET",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const getLastCards = (page = 1) => {
  return fetch(`${URL_DEV}/wishes/last`, {
    method: "GET",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const copyWish = (id) => {
  return fetch(`${URL_DEV}/wishes/${id}/copy`, {
    method: "POST",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
...
export const addCollection = (data) => {
  return fetch(`${URL_DEV}/wishlistlists`, {
    method: "POST",
    headers: headersWithAuthorizeFn(),
...
export const getCollection = (id) => {
  return fetch(`${URL_DEV}/wishlistlists/${id}`, {
    method: "GET",
    headers: headersWithAuthorizeFn(),
  }).then(checkResponse);
};
